...
| 🧠 **Edge AI en ESP32-S3** | 🚜 **Automatización Agrícola** |
| :--- | :--- |
| Despliegue de modelos de visión por computadora (**YOLOv5 / YOLOv8**) en microcontroladores y **Raspberry Pi**, gestionando el procesamiento local y el hardware. | Ingeniería de un robot fumigador autónomo con lógica **ESP32** montado sobre un chasis de metal personalizado. |
